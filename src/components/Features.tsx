...
import { Globe, Layers, Camera, Navigation } from "lucide-react";

const Features: React.FC = () => {
  return (
    <section id="features" className="section-padding bg-gradient-to-b from-white to-green-50/50">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            <span className="gradient-text">All-in-One</span> 3D Visualization Platform
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <FeatureCard
            icon={<Camera className="w-12 h-12 text-splat-vividGreen" />}
            title="Easy Training"
          ...
          <FeatureCard
            icon={<Globe className="w-12 h-12 text-splat-vividGreen" />}
          ...
          <FeatureCard
            icon={<Layers className="w-12 h-12 text-splat-vividGreen" />}
          ...
          <FeatureCard
            icon={<Navigation className="w-12 h-12 text-splat-vividGreen" />}
      ...
      <ul className="mt-auto space-y-2">
        {highlights.map((item, index) => (
          <li key={index} className="flex items-start">
            <div className="mr-2 mt-1 min-w-4 h-4 rounded-full bg-gradient-to-r from-splat-vividGreen to-splat-emerald"></div>
